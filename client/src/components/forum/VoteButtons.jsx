...
//       // Debug what's coming back from the server
//       console.log("Vote response:", response.data);
  
//       // Update the post vote count in the posts state
//       setPosts((prev) => {
//         return prev.map((p) => {
//           if (p._id === postId) {
//             // Create a new post object with the updated vote count
//             return { ...p, voteCount: response.data.voteCount };
//           }
//           return p;
//         });
//       });
