...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 bg-white shadow-lg z-50">
      <div className="w-full px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16 flex-wrap">
        {/* Logo */}
        <div className="logo flex items-center flex-shrink-0">
          <a href="index.html" className="flex items-center">
            ...
            {/* Hide the text on screens smaller than lg */}
            <h1 className="ml-2 text-2xl font-bold text-gray-800 hidden lg:block">
              Alum Connect
            </h1>
          </a>
        </div>
        {/* Desktop Navigation (shown only on large screens and up) */}
        <div className="hidden lg:flex items-center space-x-8 flex-1 justify-end">
          <ul className="flex items-center space-x-8">
            ...
            <li className="relative group">
              <a href="#about" className="text-gray-700 hover:text-gray-900 inline-block">
                About
              </a>
              <div className="absolute left-1/2 transform -translate-x-1/2 top-full mt-2 w-96 p-6 bg-white border border-gray-200 shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 ease-in-out">
                ...
                <p className="mt-4 text-sm text-gray-600">
                  ...
                  As a dynamic and innovative startup, we aim to create meaningful connections that strengthen the bond between alumni, current students, and the institution.
                </p>
                <p className="mt-4 text-sm text-gray-600">
                  Our team brings together diverse skills in web development, machine learning, app development, and design to ensure the platform is robust, scalable, and user-friendly. With a shared vision, we strive to provide a seamless experience for all users.
                </p>
                <div className="mt-4">
            ...
            <li className="relative group">
              <a href="#contact" className="text-gray-700 hover:text-gray-900 inline-block">
                Contact
              </a>
              <div className="absolute right-1/2 transform translate-x-1/2 top-full mt-2 w-96 p-6 bg-white border border-gray-200 shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 ease-in-out">
            ...
            <li>
              ...
              {mobileAbout && (
                <div className="mt-2 p-4 bg-gray-50 border border-gray-200 rounded">
                  ...
                  <p className="mt-4 text-sm text-gray-600">
                    We are DevNexus, a passionate team of dedicated developers, focused on bridging the gap between alumni and their alma mater.
                    As a dynamic and innovative startup, we aim to create meaningful connections that strengthen the bond between alumni,
                    current students, and the institution.
                  </p>
                  <p className="mt-4 text-sm text-gray-600">
                    Our team brings together diverse skills in web development, machine learning, app development, and design to ensure the platform is robust,
                    scalable, and user-friendly. With a shared vision, we strive to provide a seamless experience for all users.
                  </p>
                  <div className="mt-4">
                    <h3 className="text-center text-sm font-semibold text-gray-800">Mission</h3>
                    <p className="mt-1 text-sm text-gray-600">
                      Our mission is to empower alumni to stay connected with their college and juniors, fostering a collaborative network where knowledge,
                      experiences, and opportunities can be shared freely.
                    </p>
                    <h3 className="mt-4 text-center text-sm font-semibold text-gray-800">Vision</h3>
                    <p className="mt-1 text-sm text-gray-600">
                      We envision a thriving alumni network where every alumnus plays a vital role in the growth and development of the college community.
